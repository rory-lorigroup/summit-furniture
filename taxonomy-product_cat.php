<?php
/**
 * The template for displaying WooCommerce product category archives (formerly Types taxonomy).
 *
	...
	<main id="primary" class="site-main summit-type">
		<header class="summit-furniture-header">
			...
			<div class="summit-archive-actions">
				<a class="back-to-all-link" href="/categories/">Return to all categories</a>
		...
		<div class="summit-type-products-wrap">
			...
			if ( $query->have_posts() ) {
				while ( $query->have_posts() ) {
					...
					$post_types = get_the_terms( $post_id, 'product_cat' );
					?>
