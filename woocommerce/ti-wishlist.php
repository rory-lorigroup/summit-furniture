...
<div class="summit-single-wishlist-wrap">
	<div class="summit-single-wishlist">
		<header class="summit-account-header">
			...
			<div class="summit-folder-actions">
				<a class="summit-account-btn desktop-btn" href="/folders">Return to All Folders</a>
	...
	<form action="<?php echo esc_url( $form_url ); ?>" method="post" autocomplete="off" data-tinvwl_sharekey="<?php echo $wishlist['share_key'] ?>">
		...
		<div class="update-folder">
			<button type="submit" class="summit-btn button tinvwl-button" name="tinvwl-action-product_update" value="product_update" title="Update Wishlist" style="color:black;border-color: black; border-width: .5px;">Update Wishlist</button>
			<a class="summit-account-btn mobile-btn" href="/folders">Return to All Folders</a>
