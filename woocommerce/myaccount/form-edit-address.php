...
$page_title = ( 'billing' === $load_address ) ? esc_html__( 'Billing address', 'woocommerce' ) : esc_html__( 'Add New Shipping Address', 'woocommerce' );
...
<?php else : ?>
	...
	<form method="post" class="summit-edit-account">
