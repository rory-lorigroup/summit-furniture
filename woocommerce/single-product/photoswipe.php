	...
	<div class="pswp__scroll-wrap">
		...
		<div class="pswp__ui pswp__ui--hidden">
			...
			<div class="pswp__caption">
				...
				<p class="summit-lb-product-title">
					<?php echo esc_html($post_title) ?>
				</p>
				<p class="summit-lb-product-sku">
					<?php echo esc_html($post_sku) ?>
				</p>
				<a class="summit-lb-product-tearsheet" href="<?php echo $tearsheet ?>">Tear Sheet</a>
			</div>
		</div>
	</div>
</div>
